#ifndef COLORMAPS_MATPLOTLIB_H
#define COLORMAPS_MATPLOTLIB_H
#include <unordered_map>

namespace cm {

// CONVENIENCE TOOLS FOR COLORMAP RETRIEVAL
...
const std::unordered_map<std::string, ColorMapName> stringToColorEnum = {
...
const float _magma_data[3*256] = {0.001462f, 0.000466f, 0.013866f,
    ...
    const float _inferno_data[3*256] = {0.001462f, 0.000466f, 0.013866f,
    ...
    const float _plasma_data[3*256] = {0.050383f, 0.029803f, 0.527975f,
    ...
    const float _viridis_data[3*256] = {0.267004f, 0.004874f, 0.329415f,
    ...
    const float _cividis_data[3*256] = {0.000000f, 0.135112f, 0.304751f,
    ...
    const float _turbo_data[3*256] = {0.18995f, 0.07176f, 0.23217f,
