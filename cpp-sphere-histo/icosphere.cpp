...
SphereDepthData Icosphere::getIcosahedron(){
    ...
    return SphereDepthData(0, verticesForCurrentDepth, pointsPerTriangle);
}
...
//    }
    SphereDepthData lastSphere = RenderData::getInstance()->getSphereDepthData(maxCalculatedDepth);
